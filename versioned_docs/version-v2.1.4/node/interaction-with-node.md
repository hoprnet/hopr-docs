...
(**1**) Make sure you don't have an open payment channel with **Chao's** node. If you do, follow this [guide](#5-close-outgoing-or-incoming-channels) on how to close it.
