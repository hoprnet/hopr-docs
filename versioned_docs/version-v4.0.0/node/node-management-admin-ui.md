...
```bash
docker run -d --pull=always -p 4677:4677 --name hopr-admin-for-v4 europe-west3-docker.pkg.dev/hoprassociation/docker-images/hopr-admin:s4.0.0-pr.717-20260123134020
```
