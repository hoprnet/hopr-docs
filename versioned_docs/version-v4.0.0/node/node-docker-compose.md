...
```bash
wget https://github.com/hoprnet/hoprd/archive/refs/heads/main.zip && unzip main.zip "hoprd-main/deploy/compose/*" -d extracted_files && mv extracted_files/hoprd-main/deploy/compose . && rm -rf main.zip extracted_files
```
